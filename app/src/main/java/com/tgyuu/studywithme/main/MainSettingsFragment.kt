...
import com.tgyuu.studywithme.databinding.FragmentMainSettingsBinding

class MainSettingsFragment : BaseFragment<FragmentMainSettingsBinding>(FragmentMainSettingsBinding::inflate) {
